 ...
 */
export async function insertTaskCard(userId, chatroomId, goal, priority = 'High', setSessionContext) {
  try {
    // Set RLS context for this user/session
 ...
 */
export async function insertSubtasks(userId, chatroomId, taskCardId, subtasks, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 * @param {string} chatroomId - The chatroom ID.
 */
export async function fetchTaskCards(userId, chatroomId, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function updateSubtaskStatus(userId, chatroomId, subtaskId, status, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 * @param {number} taskCardId - The ID of the task card.
 */
export async function fetchSubtasksByTaskCard(userId, chatroomId, taskCardId, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function insertTaskDependency(userId, chatroomId, subtaskId, dependsOn, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function submitFeedback(userId, chatroomId, responseId, userFeedback, rating, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 * @param {string} chatroomId - The chatroom ID.
 */
export async function fetchFeedback(userId, chatroomId, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function logIssue(userId, chatroomId, issue, resolution, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 * @param {string} chatroomId - The chatroom ID.
 */
export async function fetchDebugLogs(userId, chatroomId, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function fetchTemplates(userId, chatroomId, setSessionContext) {
  try {
    // If you want to enforce RLS for user-specific templates:
 ...
 */
export async function deleteTaskCard(userId, chatroomId, taskCardId, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function insertHead(userId, chatroomId, name, capabilities, preferences, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function updateHead(userId, chatroomId, headId, updates, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function validateHeadInteraction(userId, chatroomId, headId, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 * @param {string} chatroomId - The chatroom ID.
 */
export async function getHeads(userId, chatroomId, setSessionContext) {
  try {
    await setSessionContext(userId, chatroomId); 
 ...
 */
export async function insertContext(userId, chatroomId, contextData, setSessionContext) {
  try {
    if (!userId || !chatroomId) {
