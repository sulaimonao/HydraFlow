...
export {
    ...
    getHeads,
    insertContext,
    fetchContext, // Ensure fetchContext is in your module exports
    updateContext, // Ensure updateContext is in your module exports
    fetchMemory,
    updateMemory,
    fetchTaskCardById, // Export the new function
    fetchTaskDependencies, // Export the new function
    fetchFeedbackByTask, // Add this
    fetchFeedbackByPersona, // Add this
    insertApiMetric, // Add this
};