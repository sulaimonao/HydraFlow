...
const setSessionContext = async (user_id, chatroom_id) => {
    const contextUpdates = [
      supabase.rpc('set_config', { key: 'request.user_id', value: user_id, is_local: true }),
      supabase.rpc('set_config', { key: 'request.chatroom_id', value: chatroom_id, is_local: true }),
    ];
